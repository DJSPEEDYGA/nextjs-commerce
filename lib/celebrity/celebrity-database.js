...
class CelebrityDatabase {
    ...
    _buildWorldwideCelebrityDB() {
        return [
            // ===== HIP-HOP / RAP =====
            { id:'c001', name:'DJ Speedy', realName:'Harvey Miller Jr', emoji:'⚡', genre:'Hip-Hop/DJ', country:'USA', city:'Miami', followers:127000, verified:true, tier:'GOAT', bio:'GOAT Royalties creator. Miami legend. Pioneer.', socialLinks:{ ig:'djspeedyga', twitter:'djspeedyga' }, musicStyle:'Trap/Hip-Hop/EDM', datePositions:['The GOAT Energy','The Hip-Hop Partner'], isCreator:true },
            ...
            { id:'c031', name:'Waka Flocka Flame', realName:'Juaquin James Malphurs', emoji:'🔥', genre:'Hip-Hop/Trap', country:'USA', city:'Atlanta', followers:485000, verified:true, tier:'Legend', bio:'HARD IN DA PAINT. No Hands. Flockaveli. ATL trap pioneer. Squad up.', socialLinks:{ ig:'wakaflocka' }, musicStyle:'Trap/Hip-Hop/Crunk', datePositions:['The Trap Romantic','The GOAT Energy'] },
        ];
    }
