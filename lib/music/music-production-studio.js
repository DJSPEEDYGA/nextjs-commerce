...
class MusicProductionStudio {
    ...
    getStats() {
        const catalog = require('../catalog/real-catalog');
        return {
            success: true,
            ...
            realCatalog: {
                ...
                distributor: catalog.stats.distributor,
                pro: catalog.stats.pro
            }
        };
    }
    ...
    getRealCatalog() {
        const catalog = require('../catalog/real-catalog');
        return catalog.getFullDashboard();
    }

    getRealWorks(page, limit) {
        const catalog = require('../catalog/real-catalog');
        return catalog.getASCAPWorks(page, limit);
    }

    getRealWakaTracks(page, limit) {
        const catalog = require('../catalog/real-catalog');
        return catalog.getWakaISRCTracks(page, limit);
    }

    searchRealCatalog(query) {
        const catalog = require('../catalog/real-catalog');
