...
class CryptoMiningManager {
    ...
    initializePools() {
        ...
        console.log('Mining pools initialized for 5 cryptocurrencies');
    }
    ...
    startMining(minerId) {
        ...
        const hashrates = {
            cpu: { btc: 0.00001, eth: 0.5, xmr: 2500, ltc: 0.1, doge: 0.1 },
            gpu: { btc: 0.0001, eth: 50, xmr: 15000, ltc: 1, doge: 1 },
            asic: { btc: 100, eth: 0, xmr: 0, ltc: 500, doge: 500 },
            cloud: { btc: 10, eth: 100, xmr: 50000, ltc: 100, doge: 100 }
        };
     ...
     */
    getWalletStatus() {
        const coins = ['bitcoin', 'ethereum', 'monero', 'litecoin', 'dogecoin'];
