AGENT-007 COMFYUI MAC RESCUE
========================

This installed a clean legacy ComfyUI copy here:

  /Volumes/FKD1/AGENT-007-THOR-ONE-FOLDER/image-runtimes/ComfyUI-Mac-Legacy
...
Start in foreground:
  ...
  bash "./START-AGENT-007-COMFYUI-FOREGROUND.sh"
...
Shared model folders still live in:
  ...
  /Volumes/FKD1/AGENT-007-THOR-ONE-FOLDER/models
